...
const BADGE_CATALOG: readonly BadgeDef[] = [
  ...
  { id: 'b3', name: 'Tidewatcher', desc: '5 cleanups', glyph: 'wave' },
  { id: 'b4', name: 'Green Thumb', desc: '3 garden events', glyph: 'sprout' },
  { id: 'b5', name: 'Early Bird', desc: 'Before 7am, 3 times', glyph: 'sun' },
