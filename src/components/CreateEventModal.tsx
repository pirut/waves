  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger asChild>
        {children || (
          <Button
            className="fixed bottom-4 right-4 sm:bottom-6 sm:right-6 h-12 w-12 sm:h-14 sm:w-14 rounded-full shadow-lg z-50 bg-[#FFE5D4] hover:bg-[#F6E8D6] text-gray-900"
            size="icon"
          >
            ...
            <div className="space-y-3">
              ...
              {geocodeStatus === 'success' && (
                <p className="text-xs text-muted-foreground">
                  Coordinates were automatically set from the address. You can manually adjust them
                  if needed.
                </p>
              )}
