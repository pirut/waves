    ...
    <footer className="bg-white border-t border-[#F6E8D6] py-6">
      <div className="max-w-6xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          ...
          <div className="md:col-span-1">
            ...
            <p className="text-xs text-gray-600 mb-3">
              Discover and explore events happening around the world through our interactive map
              platform.
            </p>
        ...
        <div className="border-t border-[#F6E8D6] mt-4 pt-4 text-center">
          <p className="text-xs text-gray-600">© 2025 Waves Map. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
